...
const MoreAboutMe = () => {
    ...
    return (
        <div className='bg-background text-foreground'>
            <div className='text-2xl'>More about me</div>
            <div className='text-xl'>
                My name is Sviatoslav, I am 15 years old (10th grade).
                ...
                I am looking for my first job or internship as a React front-end developer.
...
//Я Святослав 15 років (10 клас), з 8 класу вивчаю frontend на курсах <a href="https://profstepschool.com/school">ProfStep</a>.
...
//Шукаю першу роботу/стажування на позицію Frontend React developer,
//для мене важливо отримати досвід - труднощі й робота не лякають.
//Буду радий обговорити будь які умови <Smile />